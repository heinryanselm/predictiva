...
class RouterConstants {
  ...
  static Tween<Offset> leftToRightTween = Tween(begin: const Offset(-1, 0), end: const Offset(0, 0));
  static Tween<Offset> rightToLeftTween = Tween(begin: const Offset(1, 0), end: const Offset(0, 0));
  static Tween<Offset> topToBottomTween = Tween(begin: const Offset(0, -1), end: const Offset(0, 0));
  static Tween<Offset> bottomToTopTween = Tween(begin: const Offset(0, 1), end: const Offset(0, 0));
}
